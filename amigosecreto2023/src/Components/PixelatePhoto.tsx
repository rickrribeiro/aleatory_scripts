...
const PixelatedPhoto = ({ imageUrl, pixelSize, duration, amigoSecreto }: any) => {
  ...
  //   // setInterval(() => {
  //   //   document.getElementById('pixelated-title')!.textContent = `seu amigo secreto é:`
  //   // }, duration + 1000);
  ...
  return (
    <div className="pixelated-photo-container">
      <h1 id="pixelated-title" className="pixelated-title">seu amigo secreto é: ${amigoSecreto}</h1>
      {/* 
      <div
